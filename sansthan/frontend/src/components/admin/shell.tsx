...
const NAV = [
  {
    ...
    items: [
      ...
      { to: "/admin/command", label: "Command Centre", icon: ShieldAlert },
    ],
  },
  {
    label: "Operations",
    items: [
      ...
      { to: "/admin/volunteer-approvals", label: "Volunteers", icon: HandHeart },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/ai", label: "AI & Integrations", icon: Bot },
    ],
  },
  {
    label: "Platform",
    items: [{ to: "/admin/platform", label: "Platform Admin", icon: Settings }],
  },
];
