				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mt-1 max-w-xl text-sm text-muted-foreground" })
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2",
...
async function fetchGalleryItems() {
	...
	return (Array.isArray(data) ? data : data.results ?? []).map(mapItem$1);
}
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Photos from past celebrations, organized by year."
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [
...
async function createNewsPost(payload) {
	...
	const { data } = await api.post("/content/news/", form, { headers: { "Content-Type": "multipart/form-data" } });
	return mapItem(data);
}
async function updateNewsPost(id, payload) {
	const form = new FormData();
	form.append("title", payload.title);
	form.append("excerpt", payload.excerpt);
	form.append("content", payload.content);
	form.append("status", payload.status);
	if (payload.photo) form.append("photo", payload.photo);
	const { data } = await api.patch(`/content/news/${id}/`, form, { headers: { "Content-Type": "multipart/form-data" } });
	return mapItem(data);
}
async function deleteNewsPost(id) {
	await api.delete(`/content/news/${id}/`);
}
async function deleteNewsPosts(ids) {
...
function NewsPanel({ open, onClose, items, isLoading, error, addItem, updateItem, removeItems }) {
	const { user } = useAuth();
	const isAdmin = user?.user_type === "admin";
	...
	const filteredItems = (0, import_react.useMemo)(() => statusFilter === "all" ? items : items.filter((i) => i.status === statusFilter), [items, statusFilter]);
	if (!open) return null;
	...
	const openComposerForEdit = (item) => {
	...
	const handleSave = async (statusOverride) => {
		...
		try {
			...
			} else addItem(await createNewsPost(payload));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [!activeItem && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-1 max-w-xl text-sm text-muted-foreground",
							children: "Announcements, updates, and stories published to devotees."
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [
							isAdmin && !deleteMode && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: "inline-flex items-center gap-1.5 rounded-full bg-foreground px-4 py-2 text-sm font-medium text-background hover:opacity-90",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-3.5 w-3.5" }), "New post"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: () => setDeleteMode(true),
								className: "inline-flex items-center gap-1.5 rounded-full border border-red-200 bg-red-50 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-100",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "h-3.5 w-3.5" }), "Delete"]
							...
							isAdmin && deleteMode && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									disabled: selectedIds.length === 0 || isDeleting,
									className: "inline-flex items-center gap-1.5 rounded-full bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-40",
									children: [isDeleting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "h-3.5 w-3.5" }), "Delete selected"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => {
										setDeleteMode(false);
				...
				isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mr-1 flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-muted-foreground",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "h-3.5 w-3.5" }), "Status"]
					}), [
						"all",
						"published",
						"draft"
						...
						className: `rounded-full px-3 py-1.5 text-sm font-medium capitalize transition ${statusFilter === s ? "bg-foreground text-background" : "border border-border hover:bg-muted/60"}`,
						children: s
					}, s))]
				}),
				!isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-10 flex items-center justify-center gap-2 text-sm text-muted-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin" }), "Loading posts…"]
				}),
				error && !isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-10 rounded-2xl border border-red-200 bg-red-50 p-6 text-center text-sm text-red-600",
					children: error
				...
				!isLoading && !error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [filteredItems.map((item) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => deleteMode ? toggleSelect(item.id) : setActiveItem(item),
							className: `group relative flex flex-col overflow-hidden rounded-2xl border bg-white text-left shadow-sm ${selected ? "border-red-400 ring-2 ring-red-200" : "border-border"}`,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "aspect-[16/9] w-full overflow-hidden bg-muted/60",
								children: [
									item.photoUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Newspaper, { className: "h-6 w-6 text-muted-foreground" })
									}),
									deleteMode && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "absolute right-2 top-2 rounded-full bg-white/90 p-1",
										children: selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquareCheckBig, { className: "h-4 w-4 text-red-600" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Square, { className: "h-4 w-4 text-foreground" })
									...
									isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: `absolute left-2 top-2 rounded-full px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider ${item.status === "published" ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`,
								...
								className: "p-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "line-clamp-1 font-serif text-base font-semibold text-foreground",
									children: item.title
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					onClick: () => setActiveItem(null),
					className: "inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "h-4 w-4" }), "Back to news"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: onClose,
					className: "rounded-full p-2 hover:bg-muted/60",
					"aria-label": "Close",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [activeItem.photoUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-amber-600",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Newspaper, { className: "h-3.5 w-3.5" }), activeItem.status]
						}),
						(activeItem.author || activeItem.createdAt) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-3 text-xs text-muted-foreground",
							children: [
								"By ",
								activeItem.author ?? "Unknown",
								" on ",
						...
						isAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [isDeleting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "h-3.5 w-3.5" }), "Delete post"]
							})]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-6 flex w-fit items-center gap-1.5 rounded-full bg-muted/60 px-3 py-1.5 text-xs text-muted-foreground",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-3.5 w-3.5" }), "View only"]
		...
		}), isAdmin && composerOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "fixed inset-0 z-50 grid place-items-center bg-black/50 p-4",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl bg-white p-6 shadow-xl",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-5",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: "flex cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-border p-6 text-center hover:bg-muted/40",
							children: [draft.previewUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm font-medium text-foreground",
									children: "Choose a cover photo (optional)"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted-foreground",
									children: "JPG or PNG"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [isSaving ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "h-3.5 w-3.5" }), "Save draft"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: () => handleSave("published"),
								disabled: !draft.title.trim() || !draft.content.trim() || isSaving,
								className: "inline-flex items-center gap-1.5 rounded-full bg-foreground px-4 py-2 text-sm font-medium text-background hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40",
								children: [isSaving ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, { className: "h-3.5 w-3.5" }), "Publish"]
							})
						]
					})
				]
...
function useNewsPosts() {
	...
	const addItem = (item) => setItems((prev) => [item, ...prev]);
	const updateItem = (item) => setItems((prev) => prev.map((i) => i.id === item.id ? item : i));
	const removeItems = (ids) => setItems((prev) => prev.filter((i) => !ids.includes(i.id)));
	return {
		items,
		isLoading,
...
function CmsDashboard() {
	...
	const [newsOpen, setNewsOpen] = (0, import_react.useState)(false);
	...
	const { items: newsItems, isLoading: newsLoading, error: newsError, addItem: addNewsItem, updateItem: updateNewsItem, removeItems: removeNewsItems } = useNewsPosts();
	const stats = [
		{
			label: "Hero Banner",
			value: 3,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Manage everything a devotee sees — home, media, news, gallery, SEO, notification."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-6 border-b border-border" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			tab === "news" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(NewsPanel, {
				open: newsOpen,
